...
public:
  ...
  // Fetches, decodes, and executes the instruction pointed to by the program
  // counter
...
private:
  ...
  // Decodes the instruction, calling the function that corresponds to the
  // opcode
  ...
  // Exits the program upon encountering an invalid instruction, printing the
  // invalid instruction and instrCount map
