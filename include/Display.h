...
/**
 * @class Display
 * @brief Display class of the Chip8 that is implemented with a 64*32 array
 * where. each element is a pixel. This class provides access to and information
...
public:
  ...
  // Returns a const reference to the pixel stored at specified index in display
  // array
